...
if (userPreference === 'Sugar-free') {
    console.log("User prefers Sugar-free variety.");
} else if (userPreference === 'Regular') {
    console.log("User prefers Regular variety.");
} else {
    console.log("User preference is not set, defaulting to Regular variety.");
}
...
message = (currentTemp <= 5) ? "Chilled to perfection!" : "Needs a cooler!";
console.log(message);
...
let currentHour = 22; //the current hour in 24-hour format
